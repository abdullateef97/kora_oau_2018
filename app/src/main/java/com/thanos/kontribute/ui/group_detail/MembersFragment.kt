...
import com.thanos.kontribute.ui.group_detail.dummy.DummyContent.DummyItem

/**
 * A fragment representing a list of Items.
 * Activities containing this fragment MUST implement the
 * [MembersFragment.OnListFragmentInteractionListener] interface.
 */
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = MembersListAdapter(DummyContent.ITEMS, listener)
            }
        }
        return view
    }
